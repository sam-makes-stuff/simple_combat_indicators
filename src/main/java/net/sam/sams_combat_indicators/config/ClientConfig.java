...
public class ClientConfig {
    ...
    public static final ForgeConfigSpec.ConfigValue<Double> DAMAGE_TAKEN_INDICATOR_MIN_SIZE_SCALE;
    public static final ForgeConfigSpec.ConfigValue<Double> DAMAGE_TAKEN_INDICATOR_MAX_SIZE_SCALE;
